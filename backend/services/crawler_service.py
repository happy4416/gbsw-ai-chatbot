...
class CrawlerService:
    ...
    def crawl_school_info(self) -> List[Dict[str, str]]:
        ...
        documents.append({
            ...
            "content": """
경북소프트웨어마이스터고등학교는 대한민국 경상북도 의성군에 위치한 소프트웨어 특성화 고등학교입니다.

주요 특징:
- 설립: 2016년
- 위치: 경상북도 의성군
- 학교 유형: 마이스터고등학교 (소프트웨어 특성화)
- 교육 목표: 소프트웨어 분야의 전문 기술인 양성
...
- 프로젝트 기반 학습 (PBL)
- 기업 연계 현장실습
- 자격증 취득 지원 (정보처리기능사, 리눅스마스터 등)

졸업 후 진로:
- 대기업 및 중견기업 취업 (삼성, LG, 네이버, 카카오 등)
- 소프트웨어 개발자, 시스템 엔지니어
- 스타트업 창업
- 대학 진학 (특별전형)
...
- 1인 1노트북 지급
- 24시간 개발 환경 제공
- 동아리 활동 활성화 (해킹, 게임 개발, 앱 개발 등)
- 각종 대회 참가 지원 (해커톤, 공모전 등)
- 선배-후배 멘토링 시스템
            """,
            "source": "학교 기본 정보"
        })
